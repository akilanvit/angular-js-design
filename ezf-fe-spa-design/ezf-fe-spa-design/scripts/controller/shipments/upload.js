define(['app', 'utility/restapi', 'utility/messages'], function (app, restapi, messages) {
    app.controller('UploadShipments', ['$scope', '$bus', '$location', 'ngProgress', '$http', '$constants', 'toaster', 'fileUpload', '$rootScope',
                            ...
                            .done(function (response, status) {
                                if (response.success.length) {
                                    ...
                                    if (errors.length) {
                                        ...
                                        toaster.pop("error", messages.shipmentUploadError, "", 0);
                                    }
                                }
                                ...
                                $rootScope.activateOverlay = false;
                                toaster.pop("error", messages.shipmentUploadError);
                                ngProgress.complete();
                            });
                    } else {
