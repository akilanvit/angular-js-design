define(['app', 'utility/restapi', 'utility/messages'], function (app, restapi, messages) {
    app.controller('UploadProducts', ['$scope', '$bus', '$location', 'ngProgress', '$http', '$constants', 'toaster', 'fileUpload', '$rootScope',
                            ...
                            .done(function (response, status) {
                                if (response.success.length) {
                                    ...
                                    if (errors.length) {
                                        ...
                                        toaster.pop("error", messages.productUploadError, "", 0);
                                    }
                                }
                                ...
                                $rootScope.activateOverlay = false;
                                toaster.pop("error", messages.productUploadError);
                                ngProgress.complete();
                            });
                    } else {
